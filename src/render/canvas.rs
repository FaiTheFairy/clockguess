...
impl Canvas {
    ...
    pub(super) fn set_styled(&mut self, point: Point, ch: char, style: ContentStyle) {
        self.set_cell(point, Cell::styled(ch, style));
    }
    ...
    #[cfg(test)]
    pub(super) fn line_plain(&mut self, start: Point, end: Point, ch: char) {
...
mod tests {
    ...
    fn draws_horizontal_line() {
        ...
        canvas.line_plain(Point { x: 0, y: 1 }, Point { x: 4, y: 1 }, '#');
    ...
    fn draws_vertical_line() {
        ...
        canvas.line_plain(Point { x: 1, y: 0 }, Point { x: 1, y: 2 }, '#');
    ...
    fn draws_diagonal_line() {
        ...
        canvas.line_plain(Point { x: 0, y: 0 }, Point { x: 2, y: 2 }, '#');
    ...
    fn draws_steep_line() {
        ...
        canvas.line_plain(Point { x: 0, y: 0 }, Point { x: 2, y: 4 }, '#');
